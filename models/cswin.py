...
class CSWin(nn.Module):
    def __init__(self, model_name: str = 'T', pretrained: str = None, num_classes: int = 2, image_size: int = 224) -> None:
        super().__init__()   
        ...
        self.stage1 = nn.ModuleList([CSWinBlock(embed_dim, image_size//4, heads[0], 1, dpr=dpr[i])
